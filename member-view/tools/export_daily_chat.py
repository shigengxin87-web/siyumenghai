...
def convert(raw: dict, date: str, owner: str, avatars: dict[str, str]) -> tuple[dict, dict]:
    messages = []
    redacted_count = 0
...
def main() -> None:
    ...
    payload, report = convert(raw, args.date, args.owner, load_avatar_map(args.members))
