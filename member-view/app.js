const days = {
  ...
  '2026-07-16': {
    dateLabel: '2026 年 7 月 16 日', weekday: '星期四', messages: 4, themesCount: 1, readTime: '2 分钟',
  ...
  '2026-07-17': {
    dateLabel: '2026 年 7 月 17 日', weekday: '星期五', messages: 17, themesCount: 3, readTime: '4 分钟',
    ...
    themes: [
      ...
      { time: '14:39', title: '低价客资与中客单转化难题', text: '【黄昶】指出许多新投放 IP 的中客单转化率不足 3%；石更新补充成熟团队约 4%—5% 的案例，并提醒多数人缺少长期低转高经验和完整配置。' }
    ]
  }
};
