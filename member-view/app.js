...
let members = [
  '石更新(999社群)', '昶', '英语韩老师【工作微信】', 'Walter He', '一月语文',
  'Allen@群响', '白玉媛·o.', '李鑫', '康老师本人', '梦一世-王sir',
  '李守洲（7.31成都线下', '黄子妈', '付展鹏', '大头', '辰犀', 'Joey乔伊',
  '姚继伟', '余生姜', '代向前', 'Robin 邵震', '张聪（IP线下课变现操盘）',
  '小恒先生', '寒色渐远'
].map((name, index) => ({
  name,
  order: index + 1,
  avatar: `./assets/members/member-${String(index + 1).padStart(2, '0')}.jpg`
}));
